...
def generate_report(duplicates: Dict[str, List[str]], similar_names: List[Tuple[str, str, float]]) -> None:
    """Generate markdown and HTML reports."""
    base_dir = get_project_root()
    md_path = join_paths(base_dir, REPORTS_DIR, TESTING_DIR, f"duplicate_files{MD_EXT}")
    html_path = join_paths(base_dir, REPORTS_DIR, TESTING_DIR, f"duplicate_files{HTML_EXT}")
