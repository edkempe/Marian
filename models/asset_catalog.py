...
class AssetCatalogItem(Base):
    ...
    tags: Mapped[List["Tag"]] = relationship(
        "Tag", secondary="asset_catalog_tags", back_populates="asset_items"
    )
...
class AssetCatalogTag(Base):
    ...
    asset_id: Mapped[int] = mapped_column(
        ForeignKey("asset_catalog_items.id"), primary_key=True
    )
...
class AssetDependency(Base):
    ...
    dependency_metadata: Mapped[Optional[str]] = mapped_column(
        "metadata", Text, nullable=True
    )

    # Relationships
    source_item: Mapped["AssetCatalogItem"] = relationship(
        "AssetCatalogItem", foreign_keys=[source_id], back_populates="dependencies"
    )
    target_item: Mapped["AssetCatalogItem"] = relationship(
        "AssetCatalogItem", foreign_keys=[target_id], back_populates="dependents"
    )
...
Tag.asset_items = relationship(
    "AssetCatalogItem", secondary="asset_catalog_tags", back_populates="tags"
)
