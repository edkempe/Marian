...
def log_error(
    logger: logging.Logger, event: str, error: Exception, **kwargs: Any
) -> None:
...
def log_api_response(
    logger: logging.Logger, event: str, response: Dict[str, Any], **kwargs: Any
) -> None:
    ...
    Args:
        ...
        **kwargs: Additional context to include in log
    """
    response_data = {"event": event, "response": response, **kwargs}
    logger.info(json.dumps(response_data))


def log_db_operation(
    logger: logging.Logger, event: str, operation: str, table: str, **kwargs: Any
) -> None:
    ...
    Args:
        ...
        **kwargs: Additional context to include in log
    """
    operation_data = {"event": event, "operation": operation, "table": table, **kwargs}
    logger.info(json.dumps(operation_data))


def log_performance(
    logger: logging.Logger, operation: str, start_time: datetime
) -> None:
...
def log_system_state(logger: logging.Logger, **kwargs: Any) -> None:
    ...
    """
    state_data = {"event": "system_state", **kwargs}
...
def log_security_event(
    ...
    """
    security_data = {"event": "security", "type": event_type, "details": details}
